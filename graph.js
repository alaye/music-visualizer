...
function setup() {
    ...
    for (var name in ArtistList) {
        ...
        var dx = ArtistList[name].x,
            dy = ArtistList[name].y
    ...
    var force = d3.forceSimulation(nodes)
        .force('collision', d3.forceCollide().radius(function(node, index) {
            return node.radius
        }))
        .force('charge', d3.forceManyBody().strength(function(n, i) {
            return i == 0 ? 10 : 0
        }))
